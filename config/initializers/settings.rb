...
Settings::Db.store.defaults[:course_default_open_time] = '00:01'
Settings::Db.store.defaults[:course_default_due_time] = '07:00'
Settings::Db.store.defaults[:period_default_open_time] = '00:01'
Settings::Db.store.defaults[:period_default_due_time] = '07:00'
