  ...
  context "update step counts" do
    ...
    context "steps count" do
      ...
      it "updates counts after any change to the task" do
        ...
        Demo::AnswerExercise[task_step: task.task_steps[0], is_correct: true, is_completed: true]
        task.reload
        ...
        Demo::AnswerExercise[task_step: task.task_steps[1], is_correct: false, is_completed: true]
        task.reload
        ...
        Demo::AnswerExercise[task_step: task.task_steps[2], is_correct: true, is_completed: false]
        task.reload
        ...
        Demo::AnswerExercise[task_step: task.task_steps[3], is_correct: false, is_completed: false]
        task.reload
