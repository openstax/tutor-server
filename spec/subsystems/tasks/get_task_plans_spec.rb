...
RSpec.describe Tasks::GetTaskPlans, type: :routine do
  ...
  it 'can return the task_plan ids for which there is trouble' do
    ...
    student_tasks.first(2).each { |task| Demo::WorkTask[task: task, is_correct: false] }
    ...
    Demo::WorkTask[task: student_tasks[2], is_correct: false]
    ...
    student_tasks[3..5].each { |task| Demo::WorkTask[task: task, is_correct: true] }
    ...
    Demo::WorkTask[task: student_tasks[6], is_correct: false]
    ...
    Demo::WorkTask[task: student_tasks[7], is_correct: true]
    ...
    Demo::WorkTask[task: student_tasks[8], is_correct: false]
    ...
    Demo::WorkTask[task: student_tasks[9], is_correct: true]
