      ...
      RSpec.describe Manifest do
        context 'tutor book' do
          ...
          it 'can return ecosystem attributes' do
            ...
            expect(manifest.ecosystem_title).to(
              start_with 'Physics (93e2b09d-261c-4007-a987-0b3062fe154b@4.4)'
            )
            expect(manifest.archive_url).to eq 'https://archive-staging-tutor.cnx.org/'
            expect(manifest.book_ids).to eq ['93e2b09d-261c-4007-a987-0b3062fe154b@4.4']
            expect(manifest.exercise_ids).to eq expected_exercise_ids
          end
        ...
        context 'cc book' do
          ...
          it 'can return ecosystem attributes' do
            ...
            expect(manifest.archive_url).to eq 'https://archive.cnx.org/'
            expect(manifest.book_ids).to eq ['f10533ca-f803-490d-b935-88899941197f@2.1']
            expect(manifest.exercise_ids).to eq expected_exercise_ids
          end
