  ...
  context 'cc book' do
    ...
    let(:expected_exercise_ids)     {
      [
        ...
        '2949@2', '2950@2', '2951@2', '2952@2', '2953@2', '2954@2', '2955@2', '2956@2',
        '2957@2', '2958@2', '2959@2', '2960@2', '2961@2', '2962@2', '2963@2', '2964@2',
        '2965@2', '2966@2', '2967@2', '2968@2', '2969@2', '2970@2', '2971@2', '2972@2',
        '2973@2', '2974@2', '2975@2', '2976@2', '2977@2', '2978@2', '2979@2', '2980@2',
        '2981@2'
      ]
    }
    ...
    it 'can return ecosystem attributes' do
      expect(manifest.valid?).to eq true
      expect(manifest.title).to(
        start_with 'Mini CC Biology Tes Coll (f10533ca-f803-490d-b935-88899941197f@2.1)'
      )
      book = manifest.books.first
