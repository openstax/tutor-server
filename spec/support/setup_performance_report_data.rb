class SetupPerformanceReportData
  ...
  def answer_cc_tasks(student_tasks)
    ...
    Demo::WorkTask[task: student_1_tasks[0], is_correct: true]
    ...
    Demo::WorkTask[task: student_1_tasks[1], is_completed: is_completed, is_correct: is_correct]
    ...
    Demo::WorkTask[task: student_2_tasks[0], is_completed: is_completed, is_correct: is_correct]

    # User 2 answered 1 correct in 2nd CC
    Demo::AnswerExercise[task_step: student_2_tasks[1].task_steps.first, is_correct: true]

    # User 3 answered everything in first CC correctly
    student_3_tasks = student_tasks[2]
    Demo::WorkTask[task: student_3_tasks[0], is_correct: true]
  end
  ...
  def answer_tp_tasks(student_tasks)
    ...
    Demo::WorkTask[task: student_1_tasks[1], is_correct: false]
    ...
    Demo::WorkTask[task: student_1_tasks[2], is_completed: is_completed, is_correct: is_correct]
