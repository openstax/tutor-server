class SetupPerformanceReportData
  ...
  def exec(course:, teacher:, students: [], ecosystem:)
    ...
    AnswerExercise[task_step: student_1_tasks[2].non_core_task_steps.first,
                          is_correct: true]
    AnswerExercise[task_step: student_1_tasks[2].non_core_task_steps.last,
                          is_correct: false]
    ...
    AnswerExercise[task_step: student_2_tasks[2].core_task_steps.first,
                          is_correct: true]
