...
RSpec.describe Api::V1::NotesController, type: :routing, api: true, version: :v1 do
  context 'GET /api/courses/:course_id/notes/:chapter.:section(/role/:role_id)' do
    ...
    context 'role_id in path' do
      it 'routes to #index' do
        expect(get '/api/courses/21/notes/4.2/role/84').to route_to(
          'api/v1/notes#index',
    ...
    context 'role_id in query params' do
      it 'routes to #index' do
        expect(get '/api/courses/21/notes/4.2?role_id=84').to route_to(
          'api/v1/notes#index',
          format: 'json', course_id: '21', chapter: '4', section: '2', role_id: '84'
        )
      end
  ...
  context 'PATCH /api/courses/:course_id/notes/:chapter.:section/:id(/role/:role_id)' do
    context 'no role_id' do
    ...
    context 'role_id in path' do
      it 'routes to #update' do
        expect(patch '/api/courses/21/notes/4.2/84/role/168').to route_to(
          'api/v1/notes#update',
          format: 'json', course_id: '21', chapter: '4', section: '2', id: '84', role_id: '168'
        )
      end
    end
    ...
    context 'role_id in query params' do
      it 'routes to #update' do
        expect(patch '/api/courses/21/notes/4.2/84?role_id=168').to route_to(
          'api/v1/notes#update',
          format: 'json', course_id: '21', chapter: '4', section: '2', id: '84', role_id: '168'
        )
      end
  ...
  context 'DELETE /api/courses/:course_id/notes/:chapter.:section/:id(/role/:role_id)' do
    context 'no role_id' do
    ...
    context 'role_id in path' do
      it 'routes to #create' do
        expect(delete '/api/courses/21/notes/4.2/84/role/168').to route_to(
          'api/v1/notes#destroy',
          format: 'json', course_id: '21', chapter: '4', section: '2', id: '84', role_id: '168'
        )
      end
    ...
    context 'role_id in query params' do
      it 'routes to #create' do
        expect(delete '/api/courses/21/notes/4.2/84?role_id=168').to route_to(
          'api/v1/notes#destroy',
          format: 'json', course_id: '21', chapter: '4', section: '2', id: '84', role_id: '168'
        )
      end
  ...
  context 'GET /api/courses/:course_id/highlighted_sections(/role/:role_id)' do
    context 'no role_id' do
    ...
    context 'role_id in path' do
      it 'routes to #highlighted_sections' do
        expect(get '/api/courses/21/highlighted_sections/role/42').to route_to(
          'api/v1/notes#highlighted_sections', format: 'json', course_id: '21',role_id: '42'
        )
      end
    end
    ...
    context 'role_id in query params' do
      it 'routes to #highlighted_sections' do
        expect(get '/api/courses/21/highlighted_sections?role_id=42').to route_to(
          'api/v1/notes#highlighted_sections', format: 'json', course_id: '21', role_id: '42'
        )
      end
    end
