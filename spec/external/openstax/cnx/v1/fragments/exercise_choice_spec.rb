...
RSpec.describe OpenStax::Cnx::V1::Fragments::ExerciseChoice, :type => :external,
                                                            :vcr => VCR_OPTS do
  ...
  let!(:exercise_choice_fragments) {
    cnx_page.fragments.select do |f|
      f.is_a? OpenStax::Cnx::V1::Fragments::ExerciseChoice
    end
  }
  ...
  it "provides info about the exercise fragment" do
    exercise_choice_fragments.each do |fragment|
      ...
      fragment.exercise_fragments.each do |ex|
        expect(ex).to be_a OpenStax::Cnx::V1::Fragments::Exercise
      end
    end
  end
