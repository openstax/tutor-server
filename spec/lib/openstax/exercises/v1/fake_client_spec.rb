...
RSpec.describe OpenStax::Exercises::V1::FakeClient, type: :external do
  ...
  it 'allows searching of exercises by tag' do
    ...
    expect(JSON.parse(fake_client.exercises(tag: "billy"))['total_count']).to eq 2
    expect(JSON.parse(fake_client.exercises(tag: "billy"))['items'].count).to eq 2
    expect(JSON.parse(fake_client.exercises(tag: "franky"))['total_count']).to eq 1
    expect(JSON.parse(fake_client.exercises(tag: "franky"))['items'].count).to eq 1
    expect(JSON.parse(fake_client.exercises(tag: "tommy"))['total_count']).to eq 0
    expect(JSON.parse(fake_client.exercises(tag: "tommy"))['items'].count).to eq 0
    ...
    expect(JSON.parse(fake_client.exercises(tag: "billy", number: -1))['total_count']).to eq 1
    expect(JSON.parse(fake_client.exercises(tag: "billy", number: -1))['items'].count).to eq 1
  end
  ...
  it 'allows searching of exercises by version' do
    ...
    expect(JSON.parse(fake_client.exercises(version: 1))['total_count']).to eq 3
    expect(JSON.parse(fake_client.exercises(version: 1))['items'].count).to eq 3
  end
  ...
  it 'allows searching of exercises by version and id' do
    ...
    expect(JSON.parse(fake_client.exercises(id: "-1@1"))['total_count']).to eq 1
    expect(JSON.parse(fake_client.exercises(id: "-1@1"))['items'].count).to eq 1
    expect(JSON.parse(fake_client.exercises(id: "-2@1"))['total_count']).to eq 1
    expect(JSON.parse(fake_client.exercises(id: "-2@1"))['items'].count).to eq 1
    expect(JSON.parse(fake_client.exercises(id: "-4@1"))['total_count']).to eq 0
    expect(JSON.parse(fake_client.exercises(id: "-4@1"))['items'].count).to eq 0
  end
