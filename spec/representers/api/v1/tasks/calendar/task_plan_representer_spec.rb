...
RSpec.describe Api::V1::Tasks::Calendar::TaskPlanRepresenter, :type => :representer,
                                                              :vcr => VCR_OPTS do
  ...
  let(:representation) { Api::V1::Tasks::Calendar::TaskPlanRepresenter.new(task_plan).as_json }
