...
RSpec.describe ExportExerciseExclusions, type: :routine do
  context 'with data' do
    before(:all) do
      ...
      @teacher_user = FactoryBot.create :user_profile, first_name: 'Bob', last_name: 'Martin'
      @teacher_role = AddUserAsCourseTeacher[course: @course, user: @teacher_user]

      @book = FactoryBot.create :content_book

      @page_1 = FactoryBot.create :content_page, book: @book, book_location: [1, 1]
      @page_2 = FactoryBot.create :content_page, book: @book, book_location: [1, 2]
