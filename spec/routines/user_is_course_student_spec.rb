...
RSpec.describe UserIsCourseStudent, type: :routine do
  context "when the user is not a student for the given course" do
    it "returns false" do
      ...
      other_student_role  = FactoryBot.create :entity_role, profile: other_user
  ...
  context "when the user is a student for the given course" do
    ...
    let(:target_student_role) { FactoryBot.create :entity_role, profile: target_user }
    ...
    context "and is also a member of a non-archived period" do
      ...
      let(:new_student_role) { FactoryBot.create :entity_role, profile: target_user }
