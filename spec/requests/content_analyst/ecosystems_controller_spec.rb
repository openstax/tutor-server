...
RSpec.describe ContentAnalyst::EcosystemsController, type: :request do
  ...
  before { sign_in! content_analyst }

  context 'GET #index' do
    it 'lists ecosystems' do
      get content_analyst_ecosystems_url
  ...
  context 'GET #manifest' do
    it 'allows the ecosystem\'s manifest to be downloaded' do
      get manifest_content_analyst_ecosystem_url(ecosystem_1.id)
