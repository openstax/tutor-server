...
RSpec.describe OpenStax::Accounts::SessionsController, type: :request do
  ...
  context '#login' do
    good_return_tos = %w(https://www.cnx.org?blah http://localhost:3001 https://openstax.org)
    ...
    bad_return_tos = %w(https://www.openstax.org.spamsite.net https://www.openstax.org%0Aspamsite.net)
