...
RSpec.describe CustomerService::EcosystemsController, type: :request do
  ...
  context 'GET #index' do
    it 'lists ecosystems' do
      get customer_service_ecosystems_url
  ...
  context 'GET #manifest' do
    it 'allows the ecosystem\'s manifest to be downloaded' do
      get manifest_customer_service_ecosystem_url(ecosystem_1.id)
