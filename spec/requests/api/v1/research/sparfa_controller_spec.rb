...
RSpec.describe Api::V1::Research::SparfaController, type: :request,
                                                    api: true,
                                                    version: :v1,
                                                    speed: :slow do
  ...
  context 'POST #students' do
    ...
    it 'retrieves exercises and matrices for students with the given research_identifiers' do
      api_post api_research_sparfa_students_url, research_token, params: params.to_json
    ...
    context 'without research_identifiers' do
      ...
      context 'without calculation uuids' do
        it 'retrieves exercises and ecosystem matrices for task_plans with the given ids' do
          api_post api_research_sparfa_task_plans_url, research_token, params: params.to_json
