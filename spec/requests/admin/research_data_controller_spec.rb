...
RSpec.describe Admin::ResearchDataController, type: :request do
  ...
  context 'POST #create' do
    it 'calls ExportAndUploadResearchData and redirects to #index' do
      ...
      post admin_research_data_url, params: { export_research_data: { task_types: ["tutor"] } }
      expect(response).to redirect_to admin_research_data_url
    end
    ...
    context "assigns default dates" do
      ...
      specify "with invalid 'from' and 'to' parameters" do
        ...
        Timecop.freeze(right_now) do
          ...
          post admin_research_data_url, params: {
    ...
    it "does not export when export_research_data does not contain task_types" do
      ...
      post admin_research_data_url, params: { export_research_data: {} }
      expect(response).to redirect_to admin_research_data_url
    end
