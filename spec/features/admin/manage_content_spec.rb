...
RSpec.describe 'Administration', speed: :slow, vcr: VCR_OPTS do
  ...
  scenario 'imports a book' do
    click_link 'Import a Book into a new Ecosystem'

    fill_in 'Archive url', with: 'https://archive-staging-tutor.cnx.org/contents/'
    fill_in 'CNX id', with: '93e2b09d-261c-4007-a987-0b3062fe154b@4.4'
    click_button 'Import'

    expect(page).to have_css('.flash_notice', text: 'Book "Physics" imported.')
