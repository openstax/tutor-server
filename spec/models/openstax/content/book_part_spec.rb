...
RSpec.describe OpenStax::Content::BookPart, type: :external do
  openstax_book_infos = [
    { id: "93e2b09d-261c-4007-a987-0b3062fe154b",
      ...
      title: 'Physics',
      expected: {
        part_classes: [OpenStax::Content::BookPart]
      }
    },
    { id: "subcol",
      contents: [
      ...
      title: "Forces and Newton's Laws of Motion",
      expected: {
        part_classes: [OpenStax::Content::Page,
  ...
  def book_part_for(hash)
    OpenStax::Content::BookPart.new(hash: HashWithIndifferentAccess.new(hash).except(:expected))
  end

  it "provides info about the book part for the given hash" do
    openstax_book_infos.each do |hash|
