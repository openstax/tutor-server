class RemoveTeacherExercisesFromPagePools < ActiveRecord::Migration[5.2]
  def up
    ...
    Content::Models::Page.select(
      :id, :all_exercise_ids, :homework_core_exercise_ids, :reading_dynamic_exercise_ids,
      :reading_context_exercise_ids, :homework_dynamic_exercise_ids, :practice_widget_exercise_ids
    ).where(id: page_ids).find_each do |page|
      page.update_columns(
        all_exercise_ids: page.all_exercise_ids - teacher_exercise_ids,
        reading_context_exercise_ids: page.reading_context_exercise_ids - teacher_exercise_ids,
        reading_dynamic_exercise_ids: page.reading_dynamic_exercise_ids - teacher_exercise_ids,
        homework_core_exercise_ids: page.homework_core_exercise_ids - teacher_exercise_ids,
        homework_dynamic_exercise_ids: page.homework_dynamic_exercise_ids - teacher_exercise_ids,
        practice_widget_exercise_ids: page.practice_widget_exercise_ids - teacher_exercise_ids,
      )
    end
