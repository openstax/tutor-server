class CreateRatingsPeriodBookParts < ActiveRecord::Migration[5.2]
  def change
    create_table :ratings_period_book_parts do |t|
    ...
    add_index :ratings_period_book_parts, [ :course_membership_period_id, :book_part_uuid ],
