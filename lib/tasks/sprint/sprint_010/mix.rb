module Sprint010
  class Mix
    ...
    def exec
      ...
      tp_1 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: r_assistant,
      ...
      tp_2 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: hw_assistant,
                                                  settings: {
      ...
      tp_3 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: r_assistant,
                                                  settings: { page_ids: [3] }
      ...
      tp_4 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: hw_assistant,
                                                  settings: {
      ...
      tp_5 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: r_assistant,
                                                  settings: { page_ids: [4] }
      ...
      tp_6 = FactoryGirl.create :tasks_task_plan, owner: course,
                                                  assistant: hw_assistant,
                                                  settings: {
