class GetEcosystemFromIds
  ...
  def exec(book_ids: nil, chapter_ids: nil, page_ids: nil, exercise_ids: nil)
    book_ecosystem = nil
    unless book_ids.nil?
      book_ecosystem = ::Ecosystem::Ecosystem.find_by_book_ids(*book_ids)
    ...
    unless chapter_ids.nil?
      chapter_ecosystem = ::Ecosystem::Ecosystem.find_by_chapter_ids(*chapter_ids)
      fatal_error(code: :no_ecosystem,
    ...
    page_ecosystem = nil
    unless page_ids.nil?
      page_ecosystem = ::Ecosystem::Ecosystem.find_by_page_ids(*page_ids)
      fatal_error(code: :no_ecosystem,
    ...
    unless exercise_ids.nil?
      exercise_ecosystem = ::Ecosystem::Ecosystem.find_by_exercise_ids(*exercise_ids)
      fatal_error(code: :no_ecosystem,
