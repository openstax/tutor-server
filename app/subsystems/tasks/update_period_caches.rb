    ...
    period_bks = tocs.flat_map { |toc| toc[:books] }.group_by { |bk| bk[:title] }
      ...
      period_chs = bks.flat_map { |bk| bk[:chapters] }.group_by { |ch| ch[:book_location] }
        ...
        period_pgs = chs.flat_map { |ch| ch[:pages] }.group_by { |pg| pg[:book_location] }
          ...
          {
            id: preferred_pg[:id],
            unmapped_ids: pgs.flat_map { |pg| pg[:unmapped_ids] }.compact,
            tutor_uuid: preferred_pg[:tutor_uuid],
            unmapped_tutor_uuids: pgs.flat_map { |pg| pg[:unmapped_tutor_uuids] }.compact,
        ...
        {
          id: preferred_ch[:id],
          unmapped_ids: chs.flat_map { |ch| ch[:unmapped_ids] }.compact,
          tutor_uuid: preferred_ch[:tutor_uuid],
          unmapped_tutor_uuids: chs.flat_map { |ch| ch[:unmapped_tutor_uuids] }.compact,
      ...
      {
        id: preferred_bk[:id],
        unmapped_ids: bks.flat_map { |bk| bk[:unmapped_ids] }.compact,
        tutor_uuid: preferred_bk[:tutor_uuid],
        unmapped_tutor_uuids: bks.flat_map { |bk| bk[:unmapped_tutor_uuids] }.compact,
        title: title,
